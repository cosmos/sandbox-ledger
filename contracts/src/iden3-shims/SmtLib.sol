...
import {ArrayUtils} from "@iden3/contracts/contracts/lib/ArrayUtils.sol";
...
library SmtLib {
    ...
    /**
     * @dev SHIM: pinned iden3-contracts SmtLib hashes via PoseidonUnit{2,3}L
     * directly; newer Zeto code injects a custom IHasher. We accept the
     * registration but discard it — the internal Poseidon path is unchanged.
     */
    function setHasher(Data storage, IHasher) external pure {}
